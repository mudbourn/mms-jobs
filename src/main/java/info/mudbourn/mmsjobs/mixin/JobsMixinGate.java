...
/**
 * Gates the Jobs+ level-up mixin on the mod being loaded.
 */
public class JobsMixinGate implements IMixinConfigPlugin {

    private final boolean present = FabricLoader.getInstance().isModLoaded("jobsplus");
